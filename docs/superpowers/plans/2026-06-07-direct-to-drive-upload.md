...
- SERVER-SIDE PIPELINE COMPLETE (mint -> upload -> verify -> move -> server-authoritative billing). Remaining: 12 (chunk-proxy), 13-15 (client), 16 (middleware/rate-limits), 17 (sweep), 18 (migration run + full verification).
