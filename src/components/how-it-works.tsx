      ...
      <div className="mx-auto max-w-[1280px] px-6 md:px-8 lg:px-12">
        ...
        <div className="mt-12 md:mt-16 grid grid-cols-1 md:grid-cols-3 gap-0 relative">
          {[0, 1].map((i) => (
            <div
              key={`connector-${i}`}
              className="hidden md:block absolute h-[6px] z-0 overflow-hidden rounded-full"
              style={{
                top: "calc(32px + 24px - 1.5px)",
                left: `calc(${33.33 * (i + 1)}% - 12px)`,
                width: "24px",
              }}
            >
              ...
              <div className="absolute inset-0 overflow-hidden rounded-full motion-reduce:hidden">
                <div
                  className="absolute top-1/2 left-0 h-[6px] w-[34%] -translate-y-1/2 rounded-full animate-pipeline-connector-wave"
                  style={{
                    background:
            ...
            <div key={step.step}>
              {index > 0 && (
                <div className="flex md:hidden justify-center">
                  <div className="relative w-[6px] h-12 overflow-hidden">
                    <div className="absolute inset-0 bg-primary/15" />
                    <div className="absolute inset-0 overflow-hidden motion-reduce:hidden">
                      <div
                        className="absolute left-0 top-0 w-[6px] h-[40%] animate-pipeline-connector-wave-vertical"
                        style={{
                          background:
              ...
              <BlurFade
                ...
                inView
              >
                <div className="relative z-10 flex flex-col items-center text-center bg-card rounded-2xl p-8 mx-3 shadow-card transition-shadow duration-300 hover:shadow-card-hover">
